 ...
 * @author by Allen
 */
public class AvailableManifestListRecyclerViewAdapter extends RecyclerView.Adapter<ManifestListRecyclerViewHolder> {
    ...
    public AvailableManifestListRecyclerViewAdapter(List<ManifestListRecyclerModel> list,
    ...
    public ManifestListRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View viewItem = layoutInflater.inflate(R.layout.recycler_available_manifest_list, parent, false);
